...
class ResponsiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post responsibles_url, params: { responsible: { birthday: @responsible.birthday, cpf: @responsible.cpf, name: @responsible.name } }
    end
  ...
  test "should update responsible" do
    patch responsible_url(@responsible), params: { responsible: { birthday: @responsible.birthday, cpf: @responsible.cpf, name: @responsible.name } }
